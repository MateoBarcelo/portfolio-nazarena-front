            ...
            <div className='flex flex-col justify-center items-center'>
                <div className="justify-between md:flex md:flex-row flex-col">
                    <div className="md:justify-start md:w-2/5 md:text-start text-center w-full">
                        ...
                        <p className="text-xl text-white opacity-75">Elevando tu marca a través de diseños que inspiran y cautivan. Estoy aquí para dar vida a tus sueños a través del diseño</p>
                    ...
                    <div className='flex md:flex-row flex-col md:space-x-12 md:space-y-0 space-y-12 py-4 items-center md:items-start'>
                        ...
                        <FloatCard image="mail.svg"><a href="nazarena.diaz@hotmail.com" target="__blank">polluxdesign@gmail.com</a></FloatCard>
                    </div>
                </div>
