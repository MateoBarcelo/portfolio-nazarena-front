...
export default function ProjectCard({ project }) {
    ...
    return(
        <article className="relative border rounded shadow-lg bg-white z-10 w-[280px] h-[280px] overflow-hidden">
            ...
            <section className="h-[70px] z-20 hover:h-full transition-all overflow-hidden bg-white text-primary-900 bg-opacity-50 backdrop-blur-lg w-full absolute bottom-0 left-0 p-2">               
