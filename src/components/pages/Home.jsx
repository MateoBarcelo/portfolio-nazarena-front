...
export default function Home() {
        ...
        return(
          <motion.div initial={{opacity:0}} animate={{opacity:1}} exit={{opacity:1, transition:{duration:0.15}}}>
            ...
            <main className='md:sticky md:top-0 md:scroll-smooth h-full w-full bg-primary-400'>
              <div className='flex flex-col md:flex-row w-full md:justify-between items-center md:items-start px-32 py-16'>
                <InfoCard title="Identidad" image="pen.svg" color="bg-primary-100">Te garantizo que la empresa tenga una apariencia coherente y reconocible en todos sus materiales y plataformas.</InfoCard>
                <InfoCard title="Impresiones" image="map.png" color="bg-primary-100">Convierto tus ideas en diseños de alta calidad. Desde tarjetas hasta folletos que cuenten la historia de tu negocio.</InfoCard>
                <InfoCard title="Packaging" image="package.svg" color="bg-primary-100">Cada detalle hará presencia en el mercado. Desde membretes y sobres hasta sellos y carpetas personalizadas.</InfoCard>
              </div>
