  ...
  return (
    ...
    >
      <div className="text-center text-white">
        ...
        <p className="text-lg md:text-xl py-6 opacity-75">
          Estas son las aplicaciones que más utilizo para mis proyectos,{" "}
          <br></br> tengo gran experiencia en Illustrator, Photoshop, InDesign y
          Filmora
        </p>
      </div>
      ...
      <p className="text-center text-white text-4xl font-semibold mt-16">
        Mis proyectos
      </p>
