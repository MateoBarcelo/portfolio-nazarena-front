    ...
    return(
        <motion.div initial={{width:0}} animate={{width:"100%"}} exit={{x:window.innerWidth, transition:{duration:0.25}}}>
            ...
            <div className='w-full flex md:flex-row flex-col justify-center items-center md:space-x-24'>
                <InfoCard title="Photoshop" image="ps.svg" color="bg-primary-900" center={true}><p>Desde 2011</p></InfoCard>
                <InfoCard title="Illustrator" image="ai.svg" color="bg-primary-900" center={true}><p>Desde 2016</p></InfoCard>
                <InfoCard title="Lightroom" image="lr.svg" color="bg-primary-900" center={true}><p>Desde 2015</p></InfoCard>
