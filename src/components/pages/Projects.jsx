    ...
    return(
        <motion.div initial={{width:0}} animate={{width:"100%"}} exit={{x:window.innerWidth, transition:{duration:0.25}}}>
            <div className='text-center text-white'>
                ...
                <p className='text-lg md:text-xl py-6 opacity-75'>Estas son las aplicaciones que más utilizo para mis proyectos, <br></br> tengo gran experiencia en Canva, CorelDraw y Filmora</p>
            </div>
            <div className='w-full flex md:flex-row flex-col justify-center items-center md:space-x-24'>
                <InfoCard title="Photoshop" image="ps.svg" color="bg-primary-700" center={true}><p>Desde 2013</p></InfoCard>
